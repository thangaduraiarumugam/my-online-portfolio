...
export const EducationData = [
  {
    ...
    FieldOfStudy: "Bachelor of Engineering in Electronics and Communication",
  },
];
...
export const ClientList = [
  {
    ...
    achievements: [
      "Developed next generation integration platform for internal applications though Azure micro service and it benefited day to day activities of 25K Home office and Field Office Users",
      ...
      `Optimized page load time from 120s to 3s by redesigned application code and implemented below changes:
            JCS caching,
            Optimized search algorithm from o(n) to o (n log(n)), 
            Identified columns that needs to be indexed, 
            Identified Sub-queries and replaced it with proper joins.
        `,
  ...
  },
  {
    ...
    employeeName: "Cognizant Technology Solutions",
    achievements: [
      "Managed all phases of software development cycle for any new Design / enhancement for existing client server application",
